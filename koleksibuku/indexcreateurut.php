...
$hasil= mysqli_query ($conn, $query);
 ...
 <!DOCTYPE html>
    ...
    <body>
        ...
        mb-3 mt-1 ml-3"><i class="fas fa-user-plus mr-2"></i>Tambah Buku</a>
    ...
    <?php 
        ...
        while ($data = mysqli_fetch_array($hasil)) { ?>
            <tr>
                ...
                <td>
                    <!-- Tombol Ubah -->
                    <form action="editbuku.php" method="post" style="display:inline;">
                    ...
                    <form action="hapusbuku.php" method="post" style="display:inline;">
                        <input type="hidden" name="id_buku" value="<?php echo $data['id_buku']; ?>">
